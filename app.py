...
:root{
        --primary: #A8E6CE; /* Primary Color */
        --secondary: #FFD3B5; /* Secondary Color */
        --accent: #FFAAA6; /* Accent Color */
        --bg: white; /* Background / Soft Highlight */
        --card-bg: rgba(255,255,255,0.82);
        --muted: rgba(0,0,0,0.54);
        --border: rgba(0,0,0,0.08);
        --text: #2D3436; /* Primary text color requested */
        --text-strong: #000000; /* black for stronger emphasis */
}

html, body, .appview-container, .main, .block-container {
    background: linear-gradient(180deg, var(--bg) 0%, #f7fff6 100%);
    color: var(--text);
}
...
.movie-title { font-size: 0.9rem; line-height: 1.15rem; height: 2.3rem; overflow: hidden; color: rgba(0,0,0,0.88); }

.card {
    border: 1px solid var(--border);
    border-radius: 16px;
    padding: 14px;
    background: linear-gradient(180deg, var(--card-bg), rgba(250,250,250,0.9));
...
/* Headings and titles */
h1, h2, h3, h4, h5 { color: rgba(0,0,0,0.9); }
h1 { color: #1a3b2a; }
...
/* Accent / secondary small buttons (back links) */
.stButton.secondary>button{ background: linear-gradient(90deg, var(--secondary), var(--accent)); }
...
input:focus, textarea:focus, select:focus { outline: 2px solid rgba(168,230,206,0.45); }
...
/* Ensure sidebar text and interactive elements remain readable */
section[data-testid="stSidebar"] .block-container input,
section[data-testid="stSidebar"] .block-container select,
section[data-testid="stSidebar"] .block-container textarea,
section[data-testid="stSidebar"] .block-container button{
    color: var(--text);
}

/* Grid cards and movie tiles */
.stColumns>div .card, .stExpander { background: transparent; }
.stColumns div .card { padding: 12px; }

/* Borders for separators */
.css-1d391kg { border-color: transparent; }
div[role="status"] { color: var(--muted); }

/* Recommendation headers */
.small-muted.recommendation { color: rgba(0,0,0,0.6); }

/* Ensure links and interactive text remain readable */
a, a:visited { color: #0f5132; }

/* Subtle focus ring for accessibility */
button:focus, input:focus, select:focus, textarea:focus { box-shadow: 0 6px 18px rgba(168,230,206,0.16); }
